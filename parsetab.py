...
_lr_productions = [
  ...
  ('proca2 -> ID (','proca2',2,'p_proca2','lexer.py',171),
  ('proca1 -> datatype ID (','proca1',3,'p_proca1','lexer.py',177),
  ('procA -> proc1 ) { proc3 }','procA',5,'p_procA','lexer.py',185),
  ...
  ('function_call1 -> empty','function_call1',1,'p_function_call1','lexer.py',372),
  ('function_call1 -> function_call2','function_call1',1,'p_function_call1','lexer.py',373),
  ('function_call2 -> n_verify_argument , n_add_one_to_counter function_call2','function_call2',4,'p_function_call2','lexer.py',376),
  ('function_call2 -> n_verify_argument','function_call2',1,'p_function_call2','lexer.py',377),
  ('n_add_one_to_counter -> <empty>','n_add_one_to_counter',0,'p_n_add_one_to_counter','lexer.py',383),
  ('n_verify_argument -> expression','n_verify_argument',1,'p_n_verify_argument','lexer.py',387),
  ('return -> RETURN expression','return',2,'p_return','lexer.py',401),
  ('container_operation -> ID . OP_ARGS ( expression )','container_operation',6,'p_container_operation_arg','lexer.py',410),
  ('container_operation -> ID . OP ( )','container_operation',5,'p_container_operation','lexer.py',431),
  ('statement -> statement1 ;','statement',2,'p_statement','lexer.py',454),
  ('statement -> statement2','statement',1,'p_statement','lexer.py',455),
  ('statement1 -> assignment','statement1',1,'p_statement1','lexer.py',458),
  ('statement1 -> input','statement1',1,'p_statement1','lexer.py',459),
  ('statement1 -> output','statement1',1,'p_statement1','lexer.py',460),
  ('statement1 -> container_operation','statement1',1,'p_statement1','lexer.py',461),
  ('statement1 -> map_definition','statement1',1,'p_statement1','lexer.py',462),
  ('statement1 -> return','statement1',1,'p_statement1','lexer.py',463),
  ('statement1 -> map_assignment','statement1',1,'p_statement1','lexer.py',464),
  ('statement1 -> function_call','statement1',1,'p_statement1','lexer.py',465),
  ('statement2 -> condition','statement2',1,'p_statement2','lexer.py',468),
  ('statement2 -> while','statement2',1,'p_statement2','lexer.py',469),
  ('relop -> <','relop',1,'p_relop','lexer.py',472),
  ('relop -> >','relop',1,'p_relop','lexer.py',473),
  ('relop -> NOT_EQ','relop',1,'p_relop','lexer.py',474),
  ('relop -> EQ','relop',1,'p_relop','lexer.py',475),
  ('relop -> LEQ','relop',1,'p_relop','lexer.py',476),
  ('relop -> GEQ','relop',1,'p_relop','lexer.py',477),
  ('logop -> OR','logop',1,'p_logop','lexer.py',481),
  ('logop -> AND','logop',1,'p_logop','lexer.py',482),
  ('expression -> exp0 expression2','expression',2,'p_expression','lexer.py',678),
  ('expression2 -> logop exp0 n_quad_logop expression2','expression2',4,'p_expression2','lexer.py',681),
  ('expression2 -> empty','expression2',1,'p_expression2','lexer.py',682),
  ('n_quad_logop -> <empty>','n_quad_logop',0,'p_n_quad_logop','lexer.py',685),
  ('exp0 -> exp exp02','exp0',2,'p_exp0','lexer.py',689),
  ('exp02 -> relop exp','exp02',2,'p_exp02','lexer.py',692),
  ('exp02 -> empty','exp02',1,'p_exp02','lexer.py',693),
  ('exp -> term exp2','exp',2,'p_exp','lexer.py',698),
  ('addsub -> +','addsub',1,'p_addsub','lexer.py',701),
  ('addsub -> -','addsub',1,'p_addsub','lexer.py',702),
  ('addsub -> SET_MATH_ADDSUB','addsub',1,'p_addsub','lexer.py',703),
  ('muldiv -> *','muldiv',1,'p_muldiv','lexer.py',707),
  ('muldiv -> /','muldiv',1,'p_muldiv','lexer.py',708),
  ('muldiv -> SET_MATH_MULDIV','muldiv',1,'p_muldiv','lexer.py',709),
  ('exp2 -> addsub term n_quad_addsub exp2','exp2',4,'p_exp2','lexer.py',713),
  ('exp2 -> empty','exp2',1,'p_exp2','lexer.py',714),
  ('term -> term_not factor n_quad_muldiv term2','term',4,'p_term','lexer.py',717),
  ('n_quad_muldiv -> <empty>','n_quad_muldiv',0,'p_n_quad_muldiv','lexer.py',720),
  ('n_quad_addsub -> <empty>','n_quad_addsub',0,'p_n_quad_addsub','lexer.py',724),
  ('term2 -> muldiv factor n_quad_muldiv term2','term2',4,'p_term2','lexer.py',728),
  ('term2 -> n_quad_not','term2',1,'p_term2','lexer.py',729),
  ('n_quad_not -> <empty>','n_quad_not',0,'p_n_quad_not','lexer.py',732),
  ('term_not -> !','term_not',1,'p_term_not','lexer.py',737),
  ('term_not -> empty','term_not',1,'p_term_not','lexer.py',738),
  ('factor -> ( n_push_false_bottom expression ) n_pop_false_bottom','factor',5,'p_factor','lexer.py',743),
  ('factor -> varcte','factor',1,'p_factor','lexer.py',744),
  ('n_push_false_bottom -> <empty>','n_push_false_bottom',0,'p_n_push_false_bottom','lexer.py',747),
  ('n_pop_false_bottom -> <empty>','n_pop_false_bottom',0,'p_n_pop_false_bottom','lexer.py',751),
  ('varcte -> ID empty','varcte',2,'p_varcte','lexer.py',755),
  ('varcte -> varcte1','varcte',1,'p_varcte','lexer.py',756),
  ('varcte1 -> CTE_INT','varcte1',1,'p_varcte1','lexer.py',771),
  ('varcte1 -> CTE_FLOAT','varcte1',1,'p_varcte1','lexer.py',772),
  ('varcte1 -> CTE_BOOL','varcte1',1,'p_varcte1','lexer.py',773),
  ('varcte1 -> CTE_STRING','varcte1',1,'p_varcte1','lexer.py',774),
  ('varcte1 -> CTE_CHAR','varcte1',1,'p_varcte1','lexer.py',775),
  ('varcte1 -> function_call','varcte1',1,'p_varcte1','lexer.py',776),
  ('varcte1 -> map_access','varcte1',1,'p_varcte1','lexer.py',777),
  ('varcte1 -> container_operation','varcte1',1,'p_varcte1','lexer.py',778),
  ('functype -> datatype','functype',1,'p_functype','lexer.py',787),
  ('functype -> VOID','functype',1,'p_functype','lexer.py',788),
  ('datatype -> INT','datatype',1,'p_datatype','lexer.py',791),
  ('datatype -> FLOAT','datatype',1,'p_datatype','lexer.py',792),
  ('datatype -> BOOL','datatype',1,'p_datatype','lexer.py',793),
  ('datatype -> STRING','datatype',1,'p_datatype','lexer.py',794),
  ('datatype -> CHAR','datatype',1,'p_datatype','lexer.py',795),
  ('datatype -> set_definition','datatype',1,'p_datatype','lexer.py',796),
  ('datatype -> map_definition','datatype',1,'p_datatype','lexer.py',797),
  ('set_definition -> SET < datatype >','set_definition',4,'p_set_definition','lexer.py',801),
  ('block -> { statement_aux }','block',3,'p_block','lexer.py',805),
  ('statement_aux -> statement statement_aux','statement_aux',2,'p_statement_aux','lexer.py',808),
  ('statement_aux -> empty','statement_aux',1,'p_statement_aux','lexer.py',809),
  ('main -> MAIN n_clear_scope n_main_quad2 { vars_aux statement_aux }','main',7,'p_main','lexer.py',812),
  ('n_main_quad2 -> <empty>','n_main_quad2',0,'p_n_main_quad2','lexer.py',817),
  ('n_clear_scope -> <empty>','n_clear_scope',0,'p_n_clear_scope','lexer.py',821),
  ('vars_aux -> vars','vars_aux',1,'p_vars_aux','lexer.py',827),
  ('vars_aux -> empty','vars_aux',1,'p_vars_aux','lexer.py',828),
  ('map_definition -> MAP < datatype , datatype >','map_definition',6,'p_map_definition','lexer.py',831),
  ('map_access -> ID [ exp ]','map_access',4,'p_map_access','lexer.py',835),
  ('map_assignment -> map_access ASSIGNATOR n_quad_assign exp','map_assignment',4,'p_map_assignment','lexer.py',859),
  ('empty -> <empty>','empty',0,'p_empty','lexer.py',863),
]
